...
//    static void Main()
//    {
//        List<int> integers = new List<int>(); //Makes the list a dynamic list with changeable metrics
...
//            Console.WriteLine(); //Blank line for better visual support
...
//                    if (int.TryParse(addInput, out addInteger))
//                    {
//                        integers.Add(addInteger);
//                        Console.WriteLine($"{addInteger} added to the list.");                                        //Add an integer to the list
//                    }
//                    else
//                    {
...
//                    if (int.TryParse(removeInput, out removeInteger))
//                    {
//                        if (integers.Remove(removeInteger))
//                        {
//                            Console.WriteLine($"{removeInteger} removed from the list.");                             //Remove an integer from the list via value
//                        }
//                        else
//                        {
...
//                    int positionOfInteger;

//                    if (int.TryParse(positionInput, out positionOfInteger))
//                    {
//                        if (positionOfInteger >= 0 && positionOfInteger < integers.Count)
//                        {
//                            int removedInteger = integers[positionOfInteger];
//                            integers.RemoveAt(positionOfInteger);
//                            Console.WriteLine($"Integer {removedInteger} at position {positionOfInteger} removed.");
//                        }
//                        else
//                        {
...
//                    else
//                        Console.WriteLine($"List integers: {string.Join(", ", integers)}");                          //Print list
//                    break;
...
//                            Console.Write($"{integers[i]}{(i > 0 ? ", " : "\n")}");
//                    }
//                    break;

//                case 6:

//                    Console.WriteLine($"The list has {integers.Count} integer(s).");                                 //Print the number of elements
//                    break;
